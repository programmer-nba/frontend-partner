<template>
  ...
  <div class="bg-[#CFF6CF] min-h-screen">
    <main
      class="grid grid-cols-1 lg:grid-cols-2 gap-6 py-12 w-2xl container px-2 mx-auto"
    >
      <aside class="">
        <div class="bg-[#064635] shadow rounded-lg p-10 mb-6">
          <section class="p-2 m-3 rounded">
            <button
              @click="showDialog"
              :class="{
                'bg-[#FAF35E] text-[#15133C]': isMobile,
                'bg-[#FAF35E] text-[#001B79]': !isMobile,
              }"
            ...
            <div class="flex flex-col lg:flex-row items-center gap-5 mt-5">
              <div
                class="flex justify-evenly items-center w-full p-3 m-3 border border-[#A7FF83] rounded"
              >
                <svg
        ...
        <div class="bg-white shadow rounded-lg p-10">
          <div class="flex flex-col gap-1 text-center items-center">
            ...
            <p class="font-semibold">
              ชื่อ-สกุล : {{ userData?.partner_name }}
            </p>
            <p class="font-semibold">
              บริษัท : {{ userData?.partner_company_name }}
            </p>
            <div
              class="text-sm leading-normal text-gray-400 flex justify-center items-center"
            ></div>
          </div>
          <div class="flex justify-center items-center gap-2 my-3"></div>
        </div>
      </aside>
      ...
      <article class="">
        <form class="bg-[#064635] shadow rounded-lg mb-6 p-4">
          <div
            class="flex flex-col border border-[#C6FFC1] rounded-lg overflow-hidden"
          >
            <div class="grid grid-cols-1 sm:grid-cols-4">
              <div
                class="flex flex-col border-b sm:border-b-0 items-center p-8 sm:px-4 sm:h-full sm:justify-center"
              >
                <p class="text-xl font-bold text-white rounded-full">
                  ข้อมูลลงทะเบียน
                </p>
              </div>
              <div class="flex flex-col sm:border-l col-span-3">
                ...
                <div class="flex flex-col w-full relative bottom-0">
                  <div
                    class="grid grid-cols-1 border-t divide-x text-[#0ed3cf] bg-gray-50 py-3"
                  >
                    <a
                      class="cursor-pointer uppercase text-xs flex flex-row items-center justify-center"
                    >
                      <div class="mr-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <table class="items-center w-full bg-transparent border-collapse">
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    <button
                      @click="dialogcontact(item)"
                      class="text-white bg-[#116530] hover:bg-[#0B4619] focus:ring-4 focus:outline-none focus:ring-[#146356] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                    >
                      ดูสัญญา
                    </button>
                  </td>
    ...
    <div class="max-w-4xl mx-auto bg-white p-10">
      ...
      <div class="grid gap-6 mb-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <input
            type="text"
            v-model="partner_company_number"
        ...
        <div>
          ...
          <input
            type="text"
            v-model="partner_company_address"
        ...
        <div>
          ...
          >
          <Dropdown
            v-model="partner_company_province"
            :options="optionprovince"
            optionLabel="name_th"
            optionValue="name_th"
            placeholder="กรุณาเลือกจังหวัด"
            filter
            @change="choosecompanyprovice()"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full"
          />
        </div>
        <div>
          ...
          >
          <Dropdown
            v-model="partner_company_amphure"
            :options="optionamphurecompany"
            optionLabel="name_th"
            optionValue="name_th"
            placeholder="กรุณาเลือกอำเภอ"
            filter
            @change="choosecompanyamphure()"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full"
          />
        </div>
        <div>
          ...
          >
          <Dropdown
            v-model="partner_company_district"
            :options="optiondistrictcompany"
            optionLabel="name_th"
            optionValue="name_th"
            placeholder="กรุณาเลือกตำบล"
            filter
            @change="choosecompanydistrict()"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full"
          />
        </div>
        <div>
          <label
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
            >รหัสไปรษณีย์บริษัท</label
          >
          <input
            type="text"
            v-model="partner_company_postcode"
            placeholder="กรุณากรอกเบอร์โทรศัพท์"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
            readonly="true"
          />
        ...
        <div>
          <label
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
            >เบอร์โทรศัพท์บริษัท</label
          >
          <input
            type="text"
            v-model="partner_company_phone"
            placeholder="กรุณากรอกเบอร์โทรศัพท์บริษัท"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
          />
        </div>
        <div>
          <label
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
            >แนบบัตรประชาชน</label
          >
          <img
            class="bg-white p-2 shadow mb-4"
            :src="getImage(partner_iden_prview)"
            v-if="partner_iden_prview != '' && partner_iden_chooes == ''"
          />
          <img
            class="bg-white p-2 shadow mb-4"
            :src="partner_iden_chooes"
            v-if="partner_iden_chooes != ''"
          />
          <FileUpload
            mode="basic"
            name="demo[]"
  ...
  <img class=" bg-white p-2 shadow mb-4" :src="filecompany_chooes" v-if="filecompany_chooes != ''"> -->
          <FileUpload
            ...
            style="font-size:9px; !important;"
          />
          <div v-if="filecompany !== ''" class="text-2xl text-blue-700">
            เลือกเอกสารบริษัท
          </div>
  ...
  <img class=" bg-white p-2 shadow mb-4" :src="filecompany_chooes2" v-if="filecompany_chooes2 != ''"> -->
            <FileUpload
              ...
              :auto="true"
              class="mt-4 font bg-green-700 border-none hover:bg-green-600"
              @uploader="choosefilecompany2"
              :customUpload="true"
              :fileLimit="1"
              style="font-size:9px; !important;"
            />
            <div v-if="filecompany2 !== ''" class="text-2xl text-blue-700">
              เลือกเอกสารบริษัท
            </div>
          </div>
        </div>
...
<img class=" bg-white p-2 shadow mb-4" :src="filecompany_chooes3" v-if="filecompany_chooes3 != ''"> -->
            <FileUpload
              ...
              :auto="true"
              class="mt-4 font bg-green-700 border-none hover:bg-green-600"
              @uploader="choosefilecompany3"
              :customUpload="true"
              :fileLimit="1"
              style="font-size:9px; !important;"
            />
            <div v-if="filecompany3 !== ''" class="text-2xl text-blue-700">
              เลือกเอกสารบริษัทแล้ว
            </div>
          </div>
          <div>
            <label
              class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
              >แนบเอกสารบริษัท 4</label
            >
...
<img class=" bg-white p-2 shadow mb-4" :src="filecompany_chooes4" v-if="filecompany_chooes4 != ''"> -->
            <FileUpload
              ...
              :auto="true"
              class="mt-4 font bg-green-700 border-none hover:bg-green-600"
              @uploader="choosefilecompany4"
              :customUpload="true"
              :fileLimit="1"
              style="font-size:9px; !important;"
            />
            <div v-if="filecompany4 !== ''" class="text-2xl text-blue-700">
              เลือกเอกสารบริษัทแล้ว
            </div>
          </div>
        </div>
      ...
      <div class="py-4 border-t">
        <p class="text-lg font-bold">ลายเซ็นต์</p>
      </div>
      <div class="grid gap-6 mb-6 lg:grid-cols-2">
        <div>
          <label
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
            >ชื่อ - สกุลที่ลงนามสัญญา</label
          >
          <input
        ...
        <div>
          ...
          >
          <input
            v-model="signature_role"
            type="text"
            placeholder="เช่น ผู้มีอำนาจลงนาม, พยาน"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
          />
        </div>
        <div>
          <label
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
            >ตำแหน่งในบริษัท</label
          >
          <input
            v-model="signature_position"
            type="text"
            placeholder="เช่น ผู้บริหาร, หัวหน้าบัญชี"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
          />
        </div>
        <div>
          ...
          <div class="flex">
            <div class="flex px-5">
              <FileUpload
                ...
                style="font-size:9px; !important;"
              />
              <div v-else class="text-2xl text-blue-700">
                คุณได้เลือกลายเซ็นต์แล้ว
              </div>
            </div>
            <div class="flex">
              <button
        ...
        <div class="block w-full overflow-x-auto">
          <table class="items-center w-full bg-transparent border-collapse">
            ...
            <tr v-for="(item, index) in signature" :key="index">
              ...
              >
                <button
                  @click="deletesignal(item._id)"
                  class="text-white bg-red-500 hover:bg-400 focus:ring-4 focus:outline-none focus:ring-[#146356] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                >
                  -
                </button>
              </td>
  ...
  <Dialog
    v-model:visible="dialog_contact"
    :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
    :style="{ width: '950px', 'z-index': 1500 }"
    header="รายละเอียดสัญญา"
  >
    <div class="max-w-4xl mx-auto bg-white">
      <div class="grid gap-6 mb-6">
        {{ console.log(choose_contact) }}
        <div
          v-html="choose_contact.detail_html.body"
          v-if="contact_id != ''"
        ></div>
        <hr />
        <div class="flex justify-center items-center w-full">
          <div class="text-left">
            ...
            <span>{{ choose_contact.payment.bank_owner_name }}</span> <br />
            <span class="font-bold">เลขบัญชี :</span>
            <span>{{ choose_contact.payment.bank_number }}</span> <br />
            <span class="font-bold">ธนาคาร :</span>
            <span>{{ choose_contact.payment.bank_type }}</span> <br />
            <span class="font-bold">สาขา :</span>
            <span>{{ choose_contact.payment.bank_branch }}</span>
          </div>
        </div>
        <img
          width="100"
          :src="choose_contact.payment.bank_img"
          class="w-1/2 mx-auto"
        />
      </div>
        ...
        <div class="grid gap-6 mb-6 lg:grid-cols-2 px-3">
          <div>
            ...
            <input
              v-model="transferby"
              type="text"
              placeholder="กรุณากรอกชื่อผู้โอน"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
            />
          </div>
          <div>
      ...
      <tr v-if="signdata.length<=0"  class="border">
        ...
        <div class="flex justify-center mt-5">
          <button
            @click="accpetcontact()"
            class="text-white bg-[#116530] hover:bg-[#0B4619] focus:ring-4 focus:outline-none focus:ring-[#146356] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mx-2"
          >
            ลงนามสัญญา
          </button>
          <button
            @click="editcontact()"
            class="text-white bg-orange-600 hover:bg-[#0B4619] focus:ring-4 focus:outline-none focus:ring-[#146356] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mx-2"
          >
            แก้ไขสัญญา
          </button>
          <button
            @click="canclecontact()"
            class="text-white bg-red-600 hover:bg-[#0B4619] focus:ring-4 focus:outline-none focus:ring-[#146356] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
            ยกเลิกลงนามสัญญา
          </button>
        </div>
  ...
  >
    <div class="max-w-4xl mx-auto bg-white">
      <div class="grid gap-6">
        ...
        หนังสือสัญญา อิเล็กทรอนิกส์ ฉบับนี้จัดทำขึ้น ณ ดิจิตอล ดิเวลล็อปเปอร์
        เซอร์วิส เซ็นเตอร์ จำกัด ณ วันที่
        {{ new Date().toLocaleString() }} กับผู้ทำสัญญา .....partner_name.....
        ซึ่งบริษัทตระหนักดีถึงสิทธิในความเป็นส่วนตัวและความรับผิดชอบของบริษัทฯ
        เกี่ยวกับการเก็บรวบรวม การใช้ การเปิดเผย (“ประมวลผล”หรือ“การประมวลผล”)
        ข้อมูลส่วนบุคคลของท่าน บริษัทฯ
        ...
        1. วัตถุประสงค์
        <br />
        1.1 เพื่อแจ้งรายละเอียดเกี่ยวกับการประมวลผลข้อมูลส่วนบุคคลการเก็บรวบรวม
        ใช้ หรือเปิดเผยข้อมูลส่วนบุคคลตามตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล
        พ.ศ. 2562
        <br />
        1.2
        เพื่อป้องกันการนำข้อมูลส่วนบุคคลของเจ้าของข้อมูลส่วนบุคคลหรือบุคคลที่ติดต่อบริษัทในรูปแบบเอกสาร
        และรูปแบบอิเล็กทรอนิกส์ ไปใช้ในทางที่มิชอบ
        หรือมีการล่วงละเมิดสิทธิความเป็นส่วนตัวของข้อมูลส่วนบุคคล
        ก่อให้เกิดความเสียหายให้แก่เจ้าของข้อมูลส่วนบุคคล บริษัทฯ ดิจิตอล
        ดิเวลล็อปเปอร์ เซอร์วิส เซ็นเตอร์ จำกัด
        จึงจำกัดสิทธิการเข้าถึงข้อมูลส่วนบุคคล
        เฉพาะบุคคลที่ได้รับมอบหมายและได้รับการอนุมัติเท่านั้น โดยจะเก็บรวบรวม
        ใช้ เปิดเผย ข้อมูลส่วนบุคคลดังกล่าว
        ...
        <br />
        1.3
        เพื่อรักษาความมั่นคงปลอดภัยของข้อมูลส่วนบุคคลมิให้ข้อมูลรั่วไหลและป้องกันการนำข้อมูลดังกล่าว
        ...
        <br />
        2.2
        นโยบายฉบับนี้ใช้บังคับกับข้อมูลส่วนบุคคลของบุคคลซึ่งมีความสัมพันธ์กับบริษัทฯ
        ในปัจจุบันและที่อาจมีในอนาคต ซึ่งถูกประมวลผลข้อมูลโดยบริษัทฯ พนักงาน
        ลูกจ้างตามสัญญาจ้าง ตัวแทน คู่ค้า ผู้ให้บริการของบริษัทฯ
        รวมถึงคู่สัญญาหรือบุคคลภายนอกที่ประมวลผลข้อมูลส่วนบุคคลแทนหรือในนามของบริษัทฯ
        ภายใต้ผลิตภัณฑ์และบริการต่างๆ ที่อยู่ในความควบคุมดูแลของบริษัทฯ
        <br />
        2.3 นโยบายการคุ้มครองข้อมูลส่วนบุคคลฉบับนี้
        ได้รับการอนุมัติจากคณะกรรมการบริษัทฯ คำนิยาม
        <br />
        3. ข้อมูลส่วนบุคคล หมายถึง
        ข้อมูลเกี่ยวกับบุคคลซึ่งทำให้สามารถระบุตัวบุคคลนั้นได้ ไม่ว่าทางตรง
        หรือทางอ้อม แต่ไม่รวมถึง ข้อมูลของผู้ถึงแก่กรรมโดยเฉพาะ

        <br />
        4. ข้อมูลส่วนบุคคลที่มีความอ่อนไหว หมายถึง ข้อมูลตามที่กำหนดไว้ในมาตรา
        26
        พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคลและฉบับปรับปรุงแก้ไขตามที่จะมีการแก้ไขเป็นคราวๆ
        กฎหมายและกฎระเบียบที่ใช้บังคับอื่น รวมถึงข้อมูลบุคคลเกี่ยวกับเชื้อชาติ
        เผ่าพันธุ์ ความคิดเห็นทางการเมือง ศาสนาหรือปรัชญา พฤติกรรมทางเพศ
        ...
        5. พ.ร.บ.คุ้มครองข้อมูลส่วนบุคคล หมายถึง
        พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562
        รวมถึงกฎหมายลำดับรองที่อาศัยอำนาจ พระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล
        ในการตราขึ้น และตามที่มีการแก้ไขเป็นครั้งคราว
        <br />

        6. การประมวลผล หมายถึง การดำเนินการใดๆกับข้อมูลส่วนบุคคล เช่น
        การเก็บรวบรวม บันทึก ทำสำเนา จัดระบบ ทำโครงสร้าง เก็บรักษา ปรับปรุง
        เปลี่ยนแปลง กู้คืน ใช้ เปิดเผย ส่งต่อ เผยแพร่ โอน ผสมเข้าด้วยกัน ลบ
        ทำลาย โดยประการใดประการหนึ่งหรือหลายประการประกอบกัน

        <br />
        7. เจ้าของข้อมูลส่วนบุคคล หมายถึง
        บุคคลธรรมดาซึ่งเป็นเจ้าของข้อมูลส่วนบุคคลที่บริษัทฯ ประมวลผล
        <br />

        8. ผู้ควบคุมข้อมูลส่วนบุคคล หมายถึง
        บุคคลหรือนิติบุคคลซึ่งมีอำนาจหน้าที่ตัดสินใจเกี่ยวกับการเก็บรวบรวม ใช้
        หรือเปิดเผยข้อมูลส่วนบุคคล
        <br />

        9. ผู้ประมวลผลข้อมูลส่วนบุคคล หมายถึง
        บุคคลหรือนิติบุคคลซึ่งดำเนินการเกี่ยวกับการเก็บรวบรวม ใช้ หรือ
        เปิดเผยข้อมูลส่วนบุคคลตามคำสั่ง หรือในนามของผู้ควบคุมข้อมูลส่วนบุคคล
        <br />

        10. บริษัท หมายถึง บริษัท ทศกัณฐ์ ดิจิตอล นิว เจนเนอเรชั่นจำกัด
        <br />

        11. รูปแบบเอกสาร หมายถึง กระดาษหรือวัตถุอื่นใดซึ่งได้ทำให้ปรากฏความหมาย
        ด้วยตัวอักษร ตัวเลข ผัง หรือแผนแบบอย่างอื่น จะเป็นโดยวิธีพิมพ์ถ่ายภาพ
        หรือวิธีอื่น อันเป็นหลักฐานแห่งความหมายนั้น
        <br />

        12. รูปแบบข้อมูลอิเล็กทรอนิกส์ หมายความว่า ข้อความที่ได้สร้าง ส่ง รับ
        เก็บรักษา หรือประมวลผลด้วยวิธีการทางอิเล็กทรอนิกส์ เช่น
        วิธีการแลกเปลี่ยนข้อมูลทางอิเล็กทรอนิกส์ จดหมายอิเล็กทรอนิกส์ โทรเลข
        โทรพิมพ์ หรือโทรสาร ข้อมูลส่วนบุคคลที่เก็บรวบรวม
        <br />

        13. บริษัทฯ จะประมวลผลข้อมูลส่วนบุคคล
        ซึ่งอาจรวมถึงข้อมูลส่วนบุคคลที่มีความอ่อนไหวของท่าน ดังต่อไปนี้
        <br />
        13.1ข้อมูลส่วนบุคคลทั่วไป
        <br />
        13.1.1 ข้อมูลส่วนบุคคลที่เกี่ยวกับท่านเป็นการทั่วไป เช่น ชื่อ-นามสกุล
        เลขบัตรประจำตัวประชาชน วันเกิด อายุ อาชีพ เพศ สถานภาพทางการสมรส รูปถ่าย
        หมายเลขโทรศัพท์บ้าน ที่อยู่ปัจจุบัน หมายเลขโทรศัพท์เคลื่อนที่
        ที่อยู่ตามทะเบียนบ้าน ที่อยู่เพื่อจัดส่งไปรษณีย์
        ข้อมูลเกี่ยวกับหลักฐานแสดงตัวตน เช่น เลขที่บัตรประจำตัวประชาชน
        เลขที่หนังสือเดินทาง เลขที่บัตรคนต่างด้าว วันหมดอายุ
        ประเทศที่ออกหนังสือเดินทาง อีเมล
        เสียงการสนทนาไม่ว่าจะถูกบันทึกในรูปแบบใด และรายละเอียดข้อมูลติดต่ออื่นๆ
        <br />
        13.1.2 ข้อมูลเกี่ยวกับการทำงานของท่าน เช่น ตำแหน่งงาน สถานที่ทำงาน
        ประวัติเกี่ยวกับการทำงานของท่าน
        ซึ่งอาจรวมถึงชื่อและที่อยู่ของนายจ้างของท่าน
        <br />
        13.1.3 ข้อมูลทางการเงิน เช่น รายได้ แหล่งที่มาของรายได้ เลขบัญชีธนาคาร
        ข้อมูลเกี่ยวกับภาษี รายละเอียดเกี่ยวกับการเคลื่อนไหวของบัญชีธนาคาร
        รายละเอียดเกี่ยวกับเงินกู้ ข้อมูลเกี่ยวกับการลงทุน
        รายละเอียดเกี่ยวกับบัตรเครดิต
        และรายละเอียดหรือข้อมูลเกี่ยวกับการชำระเงินอื่นๆ
        <br />
        13.1.4 รายละเอียดผลิตภัณฑ์และ/หรือบริการต่างๆ ได้แก่
        รายละเอียดผลิตภัณฑ์และ/หรือบริการต่างๆ ที่ท่านเคยซื้อจากบริษัทฯ
        รวมถึงการใช้สิทธิต่างๆ ผลิตภัณฑ์ หรือบริการอื่นๆ ของบริษัทฯ
        <br />
        13.1.5 สถานะทางกฎหมาย เช่น สถานะเกี่ยวกับการฟอกเงิน
        ...
        เมื่อท่านใช้เว็บไซต์แอปพลิเคชันของบริษัท
        และอาจรวมถึงแพลตฟอร์มสื่อสังคมออนไลน์ของ ผู้ให้บริการอื่น เช่น
        ชื่อเรียกตัวตนเฉพาะของลูกค้าที่ใช้บนแพลตฟอร์มสื่อสังคมออนไลน์ IP Address
        คุกกี้ (Cookies) ประเภทและเวอร์ชั่นของเบราว์เซอร์ การตั้งค่าเขตเวลา
        ประเภทของปลั๊กอินในเบราว์เซอร์ ระบบปฏิบัติการและแพลตฟอร์ม ข้อมูลผู้ใช้
        (User Profile) ข้อมูลเกี่ยวกับอุปกรณ์
        ซึ่งรวมถึงข้อมูลเกี่ยวกับอุปกรณ์เคลื่อนที่
        ข้อมูลเครือข่ายไร้สายและข้อมูลครือข่ายทั่วไป
        <br />
        13.2 ข้อมูลส่วนบุคคลที่มีความอ่อนไหว บริษัทฯ
        จัดเก็บรวบรวมข้อมูลส่วนบุคคลที่มีความอ่อนไหว (Sensitive Personal Data)
        เฉพาะเท่าที่จำเป็น และจะดำเนินการแจ้งรายละเอียดที่เกี่ยวข้อง
        พร้อมขอและได้รับความยินยอมโดยชัดแจ้ง
        จากเจ้าของข้อมูลส่วนบุคคลแล้วเท่านั้น
        เว้นแต่กฎหมายจะกำหนดเป็นข้อยกเว้นไว้เป็นการเฉพาะ
        <br />
        13.2.1 ข้อมูลด้านสุขภาพและข้อมูลทางการแพทย์ของท่าน เช่น
        ประวัติการรักษาพยาบาล ประวัติการขอคำปรึกษา บันทึกการตรวจทางการแพทย์
        บันทึกการสืบสวนทางการแพทย์ บันทึกของพยาบาล ประวัติการสั่งจ่ายยา
        บันทึกการรักษา รายละเอียดการบริการทางการแพทย์ที่ได้รับ รายงานทางการแพทย์
        รายงานการชันสูตรพลิกศพ และรายละเอียดค่าใช้จ่ายทางการแพทย์
        รวมไปถึงคำถามเกี่ยวกับสุขภาพ และข้อมูลหรือสิ่งใด ๆ
        ที่แสดงออกมาในรูปเอกสาร แฟ้ม รายงาน หนังสือ แผนผัง แผนที่ ภาพวาด ภาพถ่าย
        ฟิล์ม การบันทึกภาพหรือเสียงการบันทึกโดยเครื่องมือทางอิเล็กทรอนิกส์
        ...
        <br />
        13.2.2ข้อมูลเกี่ยวประวัติการถูกดำเนินคดีความของท่าน เช่น
        ประวัติอาชญากรรม บันทึกเกี่ยวกับการดำเนินคดีไม่ว่าทางแพ่ง
        หรือการดำเนินคดีอื่นๆ รวมไปถึงรายงานของตำรวจ
        และคำสั่งศาลที่เกี่ยวข้องเท่าที่จำเป็นข้อมูลส่วนบุคคลดังกล่าวข้างต้น
        <br />
        14. แหล่งที่มาของข้อมูลส่วนบุคคลที่เก็บรวบรวม
        ไม่จำกัดเพียงการได้รับข้อมูลจากการตรวจสอบจากแหล่งข้อมูลที่เป็นสาธารณะ
        แหล่งข้อมูลส่วนตัว หรือแหล่งข้อมูลเชิงพาณิชย์ เว็บไซต์
        แหล่งข้อมูลสื่อสังคมออนไลน์ ผู้ให้บริการข้อมูล (Data Providers)
        แหล่งข้อมูลทางการแพทย์ สถานบริการสาธารณสุข โรงพยาบาล แพทย์
        บุคลากรผู้ประกอบวิชาชีพสาธารณสุขอื่น
        ...
        15. วัตถุประสงค์ของการประมวลผลข้อมูลส่วนบุคคล บริษัทฯ
        ดำเนินการเก็บรวบรวม ใช้ และเปิดเผย ส่งหรือโอน
        ข้อมูลส่วนบุคคลของเจ้าของข้อมูลส่วนบุคคล เพื่อวัตถุประสงค์ดังต่อไปนี้
        <br />
        ...
        <br />
        15.4 เพื่อการปฏิบัติตามกฎหมาย หรือการตรวจสอบธุรกิจของบริษัทฯ
        ไม่ว่าจะเป็นการตรวจสอบภายใน หรือ การตรวจสอบจากบุคคลภายนอก
        <br />
        15.5 เพื่อดำเนินการให้เป็นไปตามข้อกำหนดของกฎหมาย กฎ ระเบียบ ข้อตกลง
        หรือนโยบายที่ใช้บังคับ ซึ่งกำหนดขึ้นโดยหน่วยงานกำกับดูแลของรัฐ
        หน่วยงานที่มีหน้าที่บังคับใช้กฎหมาย หน่วยงานรัฐ
        หน่วยงานที่มีหน้าที่ระงับข้อพิพาท ไม่ว่าหน่วยงานใดก็ตาม
        <br />
        15.6 เพื่อวัตถุประสงค์ของการบังคับใช้กฎหมาย หรือการให้ความช่วยเหลือ
        ให้ความร่วมมือ การสืบสวนโดยบริษัทฯ หรือในนามของบริษัทฯ
        โดยเจ้าหน้าที่ตำรวจ หรือโดยหน่วยงานรัฐหรือหน่วยงานกำกับดูแลอื่นๆ
        ในประเทศ และการดำเนินการตามหน้าที่ในการรายงาน และข้อกำหนดต่างๆ
        ตามที่กฎหมายกำหนด
        หรือตามที่มีการตกลงเห็นชอบกับหน่วยงานรัฐหรือหน่วยงานกำกับดูแลอื่นๆ
        ในประเทศหรือเขตการปกครองใดๆ
        หรือการดำเนินการตามคำสั่งโดยชอบด้วยกฎหมายของพนักงานเจ้าหน้าที่
        หรือหน่วยงานของรัฐ
        <br />
        15.7 เพื่อการดำเนินการอื่นๆ ที่จำเป็น
        ซึ่งเกี่ยวข้องกับวัตถุประสงค์ใดๆข้างต้น
        เว้นแต่กฎหมายและกฎระเบียบที่ใช้บังคับ รวมถึง พ.ร.บ.
        คุ้มครองข้อมูลส่วนบุคคล จะอนุญาตให้กระทำเป็นอย่างอื่น บริษัทฯ
        ...
        <br />
        16. การเปิดเผยข้อมูลส่วนบุคคล การดำเนินการตามวัตถุประสงค์ต่างๆ ข้างต้น
        บริษัทฯ อาจเปิดเผยข้อมูลส่วนบุคคลของท่านให้แก่บุคคลต่าง ๆ
        ตามที่ระบุด้านล่างนี้ โดยบริษัทฯ จะดำเนินการใดๆ
        ที่จำเป็นเพื่อคุ้มครองข้อมูลส่วนบุคคลของท่านตามพ.ร.บ.
        คุ้มครองข้อมูลส่วนบุคคล บุคคลที่เป็นคู่ค้า พันธมิตรของบริษัทฯ
        หรือบุคคลภายนอกที่มีความเกี่ยวข้องกับผลิตภัณฑ์ที่มีการเสนอขายให้แก่ท่าน
        หรือผลิตภัณฑ์ที่ท่านอาจสนใจ
        <br />

        17. การโอนข้อมูลไปยังต่างประเทศ ข้อมูลส่วนบุคคลของท่านอาจถูกโอนไป
        ถูกจัดเก็บไว้ หรือประมวลผลโดยบริษัทฯ
        หรืออาจถูกส่งให้แก่บุคคลหรือหน่วยงานใดๆ ตามรายละเอียดข้างต้น
        ซึ่งอาจมีที่ตั้งหรืออาจให้บริการอยู่ในประเทศไทยหรือนอกประเทศไทย ทั้งนี้
        ข้อมูลส่วนบุคคลของท่าน จะถูกโอนไปยังสถานที่อื่นๆ
        ตามเงื่อนไขเกี่ยวกับการคุ้มครองข้อมูลส่วนบุคคล ดังที่
        พ.ร.บ.คุ้มครองข้อมูลส่วนบุคคลกำหนด
        โดยหากเป็นการโอนข้อมูลส่วนบุคคลของท่านระหว่างกลุ่มบริษัท บริษัทฯ
        จะดำเนินการตามนโยบายคุ้มครองข้อมูลส่วนบุคคลภายในกลุ่มบริษัทฯ (Binding
        Corporate Rules) ที่ได้รับการอนุมัติจากคณะกรรมการ (หากมี)
        <br />

        18. การเก็บรักษาข้อมูลส่วนบุคคล บริษัทฯ
        ...
        ทั้งนี้บริษัทฯ จะเก็บรักษา ข้อมูลส่วนบุคคลของท่านไม่เกิน 10 ปี
        นับแต่วันที่ท่านสิ้นสุดความสัมพันธ์ หรือการติดต่อครั้งสุดท้ายกับบริษัทฯ
        บริษัทฯ อาจเก็บรักษาข้อมูลส่วนบุคคลของท่านนานกว่าที่กำหนด
        หากกฎหมายอนุญาตหรือกำหนดไว้เป็นหน้าที่ของบริษัทฯ บริษัทฯ
        จะมีการดำเนินการตามขั้นตอนที่เหมาะสม เพื่อทำการลบหรือทำลาย
        หรือทำให้ข้อมูลส่วนบุคคลของท่านเป็นข้อมูลที่ไม่สามารถระบุตัวท่าน
        ตามระยะเวลาเก็บรักษาข้อมูลส่วนบุคคลข้างต้น
        <br />

        19. การใช้ข้อมูลส่วนบุคคลตามวัตถุประสงค์เดิม บริษัทฯ
        มีสิทธิในการเก็บรวบรวมและใช้ข้อมูลส่วนบุคคลของท่านที่บริษัทฯ
        ได้เก็บรวบรวมไว้ก่อนวันที่
        ...
        20. การรักษาความมั่นคงปลอดภัยของข้อมูลส่วนบุคคล บริษัทฯ
        มีการใช้มาตรการรักษาความปลอดภัยภายในบริษัทฯ
        และการใช้บังคับนโยบายอย่างเข้มงวดในการเก็บรักษาข้อมูลส่วนบุคคลของท่านให้ปลอดภัย
        ซึ่งรวมถึงการเข้ารหัสข้อมูล และมาตรการป้องกันการเข้าถึงข้อมูล โดยบริษัทฯ
        กำหนดให้บุคลากรของบริษัทฯ
        ...
        <br />
        o การควบคุมการเข้าถึงข้อมูลส่วนบุคคล โดยจัดหาอุปกรณ์ในการจัดเก็บ
        ...
        <br />
        o การบริหารจัดการการเข้าถึงของผู้ใช้งาน (user access management)
        เพื่อควบคุมการเข้าถึง
        <br />
        o การกำหนดหน้าที่ความรับผิดชอบของผู้ใช้งาน (user responsibilities)
        เพื่อป้องกันการเข้าถึงข้อมูลส่วนบุคคลโดยไม่ได้รับอนุญาต การเปิดเผย
        การล่วงรู้ หรือการลักลอบทำสำเนาข้อมูลส่วนบุคคล
        ...
        โดยจัดให้มีวิธีการเพื่อให้สามารถตรวจสอบย้อนหลังเกี่ยวกับการเข้าถึง
        เปลี่ยนแปลง ลบ หรือถ่ายโอนข้อมูลส่วนบุคคล
        ให้สอดคล้องเหมาะสมกับวิธีการและสื่อที่ใช้ในการเก็บรวบรวม ใช้
        หรือเปิดเผยข้อมูลส่วนบุคคล
        ...
        <br />
        21.1 สิทธิในการเพิกถอน
        หรือร้องขอให้เปลี่ยนแปลงขอบเขตความยินยอมของท่านที่ได้ให้ไว้กับบริษัทฯ
        <br />
        ...
        <br />
        21.4.3
        การประมวลผลส่วนบุคคลเพื่อวัตถุประสงค์เกี่ยวกับการศึกษาวิจัยทางวิทยาศาสตร์
        ...
        <br />
        21.6
        สิทธิในการขอให้ระงับการประมวลผลข้อมูลส่วนบุคคลของท่านตามหลักเกณฑ์ที่กฎหมายกำหนด
        <br />
        21.7 สิทธิในการขอให้แก้ไขข้อมูลส่วนบุคคลใดๆ ที่เกี่ยวข้องกับท่าน
        ให้ถูกต้อง เป็นปัจจุบัน สมบูรณ์และไม่ก่อให้เกิดความเข้าใจผิด หากบริษัทฯ
        ไม่สามารถดำเนินการให้ได้
        ...
        และตามหลักเกณฑ์ที่กฎหมายกำหนด อย่างไรก็ดี ในกรณีที่กฎหมายอนุญาต บริษัทฯ
        อาจมีการเรียกเก็บค่าใช้จ่าย ในการดำเนินการตามสิทธิของ
        เจ้าของข้อมูลส่วนบุคคล ที่ท่านร้องขอตามความเหมาะสม
        <br />
        22. การแก้ไขเปลี่ยนแปลงนโยบายฉบับนี้ บริษัทฯ ขอสงวนสิทธิ์ในการแก้ไข
        เพิ่มเติม เปลี่ยนแปลง ปรับปรุง หรือปรับเปลี่ยนนโยบายฉบับนี้
        เท่าที่กฎหมายอนุญาต หากเป็นการเปลี่ยนแปลงในสาระสำคัญของนโยบายฉบับนี้
        บริษัทฯ จะแจ้งการแก้ไข การเปลี่ยนแปลง การปรับปรุง
        หรือการปรับเปลี่ยนนโยบายให้ท่านทราบ และ/หรือจะขอความยินยอมจากท่าน
        ...
        หรือต้องการข้อมูลเพิ่มเติมเกี่ยวกับแนวทางปฏิบัติของบริษัทฯ
        เกี่ยวกับการคุ้มครองข้อมูลส่วนบุคคลของท่าน
        หรือต้องการใช้สิทธิเกี่ยวกับข้อมูลส่วนบุคคลของท่านกรุณาติดต่อ
        เจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล (Data Protection officer)
        สัญญานี้ทำขึ้นสองฉบับมีข้อความถูกต้องตรงกัน
        คู่สัญญาแต่ละฝ่ายได้อ่านโดยตลอดแล้ว เห็นว่าถูกต้องตามความประสงค์
        จึงลงลายมือชื่อและประทับตราสำคัญของบริษัท(ถ้ามี) ไว้เป็นสำคัญต่อหน้าพยาน

        <!-- // ทำ checkbox ให้เป็นตัวเลือก -->
        <b class="text-center"
          ><input type="checkbox" v-model="statuspdpa" />
...
export default {
  ...
  data() {
    return {
      ...
      userData: {},
      visible: false,
      optionantecedent: [{ name: "นาย" }, { name: "นาง" }, { name: "นางสาว" }],
      optionprovince: [],
      optionamphure: [],
      optiondistrict: [],
  ...
  methods: {
    ...
    async accpetcontact() {
      ...
      await this.partner
        .PaidContract(data2, this.contact_id)
        .then(async (res) => {
          if (res.status == true) {
            await this.partner
              .AccpetContract(data, this.contact_id)
              .then(async (res) => {
                if (res.status == true) {
                  this.$toast.add({
                    severity: "success",
    ...
    async editcontact() {
      ...
      await this.partner
        .EditContract(data, this.contact_id)
        .then(async (res) => {
          if (res.status == true) {
            this.$toast.add({
              severity: "success",
    ...
    async canclecontact() {
      ...
      await this.partner
        .CancleContract(data, this.contact_id)
        .then(async (res) => {
          if (res.status == true) {
            this.$toast.add({
              severity: "success",
    ...
    async loadUserData() {
      try {
        ...
        const response = await axios.get(
          `${process.env.VUE_APP_API}/partner/me`,
          {
            headers: {
        ...
        await this.partner
          .Getbypartnerid(this.$store.getters._id)
          .then(async (res) => {
            ...
            this.partner_company_address =
              this.userData?.partner_company_address;
            this.partner_company_phone = this.userData?.partner_company_phone;
            this.partner_company_province =
              this.userData?.partner_company_province;
            await this.choosecompanyprovice();
            this.partner_company_amphure =
              this.userData?.partner_company_amphure;
            await this.choosecompanyamphure();
            this.partner_company_district =
              this.userData?.partner_company_district;
            await this.choosecompanydistrict();
            this.partner_company_postcode =
              this.userData?.partner_company_postcode;
    ...
    async choosecompanyprovice() {
      ...
      await this.partner.GetAmphure(provice.id).then(async (res) => {
        this.optionamphurecompany = res.filter(
          (el) => el.province_id === provice.id
        );
      });
    },
    async choosecompanyamphure() {
      ...
      await this.partner.GetTambon(amphure.id).then(async (res) => {
        this.optiondistrictcompany = this.optiondistrict = res.filter(
          (el) => el.amphure_id === amphure.id
        );
      });
    },
